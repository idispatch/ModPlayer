...
namespace TagLib
{
    namespace MPEG
    {
        class HeaderPrivate : public RefCounter
        {
        public:
            HeaderPrivate()
                : isValid(false),
...
void MPEG::Header::parse(const ByteVector &data)
{
    ...
    static const int bitrates[2][3][16] = { { // Version 1
    ...
    static const int sampleRates[3][4] = { { 44100, 48000, 32000, 0 }, // Version 1
