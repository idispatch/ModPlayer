...
RIFF::AIFF::Properties::Properties(const ByteVector &data,
    Properties::ReadStyle style)
    : AudioProperties(style)
{
    d = new TagLib::RIFF::AIFF::PropertiesPrivate;
    read(data);
}
...
void RIFF::AIFF::Properties::read(const ByteVector &data)
{
    ...
    double sampleRate = ConvertFromIeeeExtended(
        reinterpret_cast<const uchar *>(data.data() + 8));
