...
{
public:
  PropertiesPrivate(const ByteVector &d, long length, Properties::ReadStyle s) :
    data(d),
    streamLength(length),
    style(s),
    length(0),
...
WavPack::Properties::Properties(const ByteVector &data, long streamLength, Properties::ReadStyle style) : AudioProperties(style)
{
  d = new PropertiesPrivate(data, streamLength, style);
  read();
}

WavPack::Properties::Properties(File *file, long streamLength, Properties::ReadStyle style) : AudioProperties(style)
{
