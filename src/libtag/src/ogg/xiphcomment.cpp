...
XiphComment::XiphComment() : TagLib::Tag()
{
  d = new XiphCommentPrivate;
}

XiphComment::XiphComment(const ByteVector &data) : TagLib::Tag()
{
  d = new XiphCommentPrivate;
  parse(data);
}
...
String XiphComment::title() const
{
...
String XiphComment::artist() const
{
...
String XiphComment::album() const
{
...
String XiphComment::comment() const
{
...
String XiphComment::genre() const
{
...
TagLib::uint XiphComment::year() const
{
...
TagLib::uint XiphComment::track() const
{
...
void XiphComment::setTitle(const String &s)
{
  addField("TITLE", s);
}

void XiphComment::setArtist(const String &s)
{
  addField("ARTIST", s);
}

void XiphComment::setAlbum(const String &s)
{
  addField("ALBUM", s);
}

void XiphComment::setComment(const String &s)
{
  addField(d->commentField.isEmpty() ? "DESCRIPTION" : d->commentField, s);
}

void XiphComment::setGenre(const String &s)
{
  addField("GENRE", s);
}

void XiphComment::setYear(uint i)
{
  removeField("YEAR");
  if(i == 0)
    removeField("DATE");
...
void XiphComment::setTrack(uint i)
{
...
bool XiphComment::isEmpty() const
{
...
TagLib::uint XiphComment::fieldCount() const
{
  uint count = 0;
...
const FieldListMap &XiphComment::fieldListMap() const
{
  return d->fieldListMap;
}

PropertyMap XiphComment::properties() const
{
  return d->fieldListMap;
}

PropertyMap XiphComment::setProperties(const PropertyMap &properties)
{
...
bool XiphComment::checkKey(const String &key)
{
  if(key.size() < 1)
    return false;
...
String XiphComment::vendorID() const
{
  return d->vendorID;
}

void XiphComment::addField(const String &key, const String &value, bool replace)
{
  if(replace)
...
void XiphComment::removeField(const String &key, const String &value)
{
  if(!value.isNull()) {
...
bool XiphComment::contains(const String &key) const
{
  return d->fieldListMap.contains(key) && !d->fieldListMap[key].isEmpty();
}

ByteVector XiphComment::render() const
{
  return render(true);
}

ByteVector XiphComment::render(bool addFramingBit) const
{
  ByteVector data;
...
void XiphComment::parse(const ByteVector &data)
{
