...
namespace TagLib {
  ...
  namespace ASF {
    ...
    private:
      ...
      friend class TagLib::ASF::FilePrivate;
      friend class TagLib::ASF::UnknownObject;
      friend class TagLib::ASF::FilePropertiesObject;
      friend class TagLib::ASF::StreamPropertiesObject;
      friend class TagLib::ASF::ContentDescriptionObject;
      friend class TagLib::ASF::ExtendedContentDescriptionObject;
      friend class TagLib::ASF::HeaderExtensionObject;
      friend class TagLib::ASF::MetadataObject;
      friend class TagLib::ASF::MetadataLibraryObject;
      TagLib::ASF::FilePrivate *d;
    };
