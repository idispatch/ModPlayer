...
enum id3_file_mode {
    ID3_FILE_MODE_READONLY = 0, ID3_FILE_MODE_READWRITE
};
...
struct id3_frame *id3_tag_findframe(struct id3_tag const *, char const *,
        unsigned int);
...
int id3_field_setbinarydata(union id3_field *, id3_byte_t const *,
        id3_length_t);
