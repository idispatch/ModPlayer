...
MOBILITY += sensors
QT += network
LIBS += -lbb -lbbdata -lbbutility -lbbsystem -lbbplatform -lbbmultimedia -lbbcascadespickers -lasound -lcrypto -lscreen -lcurl -lpackageinfo -lbbdevice -lQtLocationSubset -laudio_manager
