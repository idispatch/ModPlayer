...
config_pri_source_group1 {
    SOURCES += \
        ...
        $$quote($$BASEDIR/src/libtag/src/ape/apefile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/ape/apefooter.cpp) \
        $$quote($$BASEDIR/src/libtag/src/ape/apeitem.cpp) \
        $$quote($$BASEDIR/src/libtag/src/ape/apeproperties.cpp) \
        $$quote($$BASEDIR/src/libtag/src/ape/apetag.cpp) \
        $$quote($$BASEDIR/src/libtag/src/asf/asfattribute.cpp) \
        $$quote($$BASEDIR/src/libtag/src/asf/asffile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/asf/asfpicture.cpp) \
        $$quote($$BASEDIR/src/libtag/src/asf/asfproperties.cpp) \
        $$quote($$BASEDIR/src/libtag/src/asf/asftag.cpp) \
        $$quote($$BASEDIR/src/libtag/src/audioproperties.cpp) \
        $$quote($$BASEDIR/src/libtag/src/fileref.cpp) \
        $$quote($$BASEDIR/src/libtag/src/flac/flacfile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/flac/flacmetadatablock.cpp) \
        $$quote($$BASEDIR/src/libtag/src/flac/flacpicture.cpp) \
        $$quote($$BASEDIR/src/libtag/src/flac/flacproperties.cpp) \
        $$quote($$BASEDIR/src/libtag/src/flac/flacunknownmetadatablock.cpp) \
        $$quote($$BASEDIR/src/libtag/src/it/itfile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/it/itproperties.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mod/modfile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mod/modfilebase.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mod/modproperties.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mod/modtag.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mp4/mp4atom.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mp4/mp4coverart.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mp4/mp4file.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mp4/mp4item.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mp4/mp4properties.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mp4/mp4tag.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpc/mpcfile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpc/mpcproperties.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v1/id3v1genres.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v1/id3v1tag.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/attachedpictureframe.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/commentsframe.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/generalencapsulatedobjectframe.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/ownershipframe.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/popularimeterframe.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/privateframe.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/relativevolumeframe.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/textidentificationframe.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/uniquefileidentifierframe.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/unknownframe.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/unsynchronizedlyricsframe.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/urllinkframe.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/id3v2extendedheader.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/id3v2footer.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/id3v2frame.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/id3v2framefactory.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/id3v2header.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/id3v2synchdata.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/id3v2tag.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/mpegfile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/mpegheader.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/mpegproperties.cpp) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/xingheader.cpp) \
        $$quote($$BASEDIR/src/libtag/src/ogg/flac/oggflacfile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/ogg/oggfile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/ogg/oggpage.cpp) \
        $$quote($$BASEDIR/src/libtag/src/ogg/oggpageheader.cpp) \
        $$quote($$BASEDIR/src/libtag/src/ogg/opus/opusfile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/ogg/opus/opusproperties.cpp) \
        $$quote($$BASEDIR/src/libtag/src/ogg/speex/speexfile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/ogg/speex/speexproperties.cpp) \
        $$quote($$BASEDIR/src/libtag/src/ogg/vorbis/vorbisfile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/ogg/vorbis/vorbisproperties.cpp) \
        $$quote($$BASEDIR/src/libtag/src/ogg/xiphcomment.cpp) \
        $$quote($$BASEDIR/src/libtag/src/riff/aiff/aifffile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/riff/aiff/aiffproperties.cpp) \
        $$quote($$BASEDIR/src/libtag/src/riff/rifffile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/riff/wav/infotag.cpp) \
        $$quote($$BASEDIR/src/libtag/src/riff/wav/wavfile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/riff/wav/wavproperties.cpp) \
        $$quote($$BASEDIR/src/libtag/src/s3m/s3mfile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/s3m/s3mproperties.cpp) \
        $$quote($$BASEDIR/src/libtag/src/tag.cpp) \
        $$quote($$BASEDIR/src/libtag/src/tagunion.cpp) \
        $$quote($$BASEDIR/src/libtag/src/toolkit/tbytevector.cpp) \
        $$quote($$BASEDIR/src/libtag/src/toolkit/tbytevectorlist.cpp) \
        $$quote($$BASEDIR/src/libtag/src/toolkit/tbytevectorstream.cpp) \
        $$quote($$BASEDIR/src/libtag/src/toolkit/tdebug.cpp) \
        $$quote($$BASEDIR/src/libtag/src/toolkit/tdebuglistener.cpp) \
        $$quote($$BASEDIR/src/libtag/src/toolkit/tfile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/toolkit/tfilestream.cpp) \
        $$quote($$BASEDIR/src/libtag/src/toolkit/tiostream.cpp) \
        $$quote($$BASEDIR/src/libtag/src/toolkit/tpropertymap.cpp) \
        $$quote($$BASEDIR/src/libtag/src/toolkit/trefcounter.cpp) \
        $$quote($$BASEDIR/src/libtag/src/toolkit/tstring.cpp) \
        $$quote($$BASEDIR/src/libtag/src/toolkit/tstringlist.cpp) \
        $$quote($$BASEDIR/src/libtag/src/toolkit/unicode.cpp) \
        $$quote($$BASEDIR/src/libtag/src/trueaudio/trueaudiofile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/trueaudio/trueaudioproperties.cpp) \
        $$quote($$BASEDIR/src/libtag/src/wavpack/wavpackfile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/wavpack/wavpackproperties.cpp) \
        $$quote($$BASEDIR/src/libtag/src/xm/xmfile.cpp) \
        $$quote($$BASEDIR/src/libtag/src/xm/xmproperties.cpp) \
    ...
    HEADERS += \
        ...
        $$quote($$BASEDIR/src/libtag/aifffile.h) \
        $$quote($$BASEDIR/src/libtag/aiffproperties.h) \
        $$quote($$BASEDIR/src/libtag/apefile.h) \
        $$quote($$BASEDIR/src/libtag/apefooter.h) \
        $$quote($$BASEDIR/src/libtag/apeitem.h) \
        $$quote($$BASEDIR/src/libtag/apeproperties.h) \
        $$quote($$BASEDIR/src/libtag/apetag.h) \
        $$quote($$BASEDIR/src/libtag/asfattribute.h) \
        $$quote($$BASEDIR/src/libtag/asffile.h) \
        $$quote($$BASEDIR/src/libtag/asfpicture.h) \
        $$quote($$BASEDIR/src/libtag/asfproperties.h) \
        $$quote($$BASEDIR/src/libtag/asftag.h) \
        $$quote($$BASEDIR/src/libtag/attachedpictureframe.h) \
        $$quote($$BASEDIR/src/libtag/audioproperties.h) \
        $$quote($$BASEDIR/src/libtag/commentsframe.h) \
        $$quote($$BASEDIR/src/libtag/fileref.h) \
        $$quote($$BASEDIR/src/libtag/flacfile.h) \
        $$quote($$BASEDIR/src/libtag/flacmetadatablock.h) \
        $$quote($$BASEDIR/src/libtag/flacpicture.h) \
        $$quote($$BASEDIR/src/libtag/flacproperties.h) \
        $$quote($$BASEDIR/src/libtag/generalencapsulatedobjectframe.h) \
        $$quote($$BASEDIR/src/libtag/id3v1genres.h) \
        $$quote($$BASEDIR/src/libtag/id3v1tag.h) \
        $$quote($$BASEDIR/src/libtag/id3v2extendedheader.h) \
        $$quote($$BASEDIR/src/libtag/id3v2footer.h) \
        $$quote($$BASEDIR/src/libtag/id3v2frame.h) \
        $$quote($$BASEDIR/src/libtag/id3v2framefactory.h) \
        $$quote($$BASEDIR/src/libtag/id3v2header.h) \
        $$quote($$BASEDIR/src/libtag/id3v2synchdata.h) \
        $$quote($$BASEDIR/src/libtag/id3v2tag.h) \
        $$quote($$BASEDIR/src/libtag/infotag.h) \
        $$quote($$BASEDIR/src/libtag/itfile.h) \
        $$quote($$BASEDIR/src/libtag/itproperties.h) \
        $$quote($$BASEDIR/src/libtag/modfile.h) \
        $$quote($$BASEDIR/src/libtag/modfilebase.h) \
        $$quote($$BASEDIR/src/libtag/modproperties.h) \
        $$quote($$BASEDIR/src/libtag/modtag.h) \
        $$quote($$BASEDIR/src/libtag/mp4atom.h) \
        $$quote($$BASEDIR/src/libtag/mp4coverart.h) \
        $$quote($$BASEDIR/src/libtag/mp4file.h) \
        $$quote($$BASEDIR/src/libtag/mp4item.h) \
        $$quote($$BASEDIR/src/libtag/mp4properties.h) \
        $$quote($$BASEDIR/src/libtag/mp4tag.h) \
        $$quote($$BASEDIR/src/libtag/mpcfile.h) \
        $$quote($$BASEDIR/src/libtag/mpcproperties.h) \
        $$quote($$BASEDIR/src/libtag/mpegfile.h) \
        $$quote($$BASEDIR/src/libtag/mpegheader.h) \
        $$quote($$BASEDIR/src/libtag/mpegproperties.h) \
        $$quote($$BASEDIR/src/libtag/oggfile.h) \
        $$quote($$BASEDIR/src/libtag/oggflacfile.h) \
        $$quote($$BASEDIR/src/libtag/oggpage.h) \
        $$quote($$BASEDIR/src/libtag/oggpageheader.h) \
        $$quote($$BASEDIR/src/libtag/opusfile.h) \
        $$quote($$BASEDIR/src/libtag/opusproperties.h) \
        $$quote($$BASEDIR/src/libtag/ownershipframe.h) \
        $$quote($$BASEDIR/src/libtag/popularimeterframe.h) \
        $$quote($$BASEDIR/src/libtag/privateframe.h) \
        $$quote($$BASEDIR/src/libtag/relativevolumeframe.h) \
        $$quote($$BASEDIR/src/libtag/rifffile.h) \
        $$quote($$BASEDIR/src/libtag/s3mfile.h) \
        $$quote($$BASEDIR/src/libtag/s3mproperties.h) \
        $$quote($$BASEDIR/src/libtag/speexfile.h) \
        $$quote($$BASEDIR/src/libtag/speexproperties.h) \
        $$quote($$BASEDIR/src/libtag/src/flac/flacunknownmetadatablock.h) \
        $$quote($$BASEDIR/src/libtag/src/mod/modfileprivate.h) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/attachedpictureframe.h) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/commentsframe.h) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/generalencapsulatedobjectframe.h) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/ownershipframe.h) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/popularimeterframe.h) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/privateframe.h) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/relativevolumeframe.h) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/textidentificationframe.h) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/uniquefileidentifierframe.h) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/unknownframe.h) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/unsynchronizedlyricsframe.h) \
        $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames/urllinkframe.h) \
        $$quote($$BASEDIR/src/libtag/src/tagunion.h) \
        $$quote($$BASEDIR/src/libtag/src/toolkit/tdebug.h) \
        $$quote($$BASEDIR/src/libtag/src/toolkit/tutils.h) \
        $$quote($$BASEDIR/src/libtag/src/toolkit/unicode.h) \
        $$quote($$BASEDIR/src/libtag/tag.h) \
        $$quote($$BASEDIR/src/libtag/tag_c.h) \
        $$quote($$BASEDIR/src/libtag/taglib.h) \
        $$quote($$BASEDIR/src/libtag/taglib_config.h) \
        $$quote($$BASEDIR/src/libtag/taglib_export.h) \
        $$quote($$BASEDIR/src/libtag/tbytevector.h) \
        $$quote($$BASEDIR/src/libtag/tbytevectorlist.h) \
        $$quote($$BASEDIR/src/libtag/tbytevectorstream.h) \
        $$quote($$BASEDIR/src/libtag/tdebuglistener.h) \
        $$quote($$BASEDIR/src/libtag/textidentificationframe.h) \
        $$quote($$BASEDIR/src/libtag/tfile.h) \
        $$quote($$BASEDIR/src/libtag/tfilestream.h) \
        $$quote($$BASEDIR/src/libtag/tiostream.h) \
        $$quote($$BASEDIR/src/libtag/tlist.h) \
        $$quote($$BASEDIR/src/libtag/tmap.h) \
        $$quote($$BASEDIR/src/libtag/tpropertymap.h) \
        $$quote($$BASEDIR/src/libtag/trefcounter.h) \
        $$quote($$BASEDIR/src/libtag/trueaudiofile.h) \
        $$quote($$BASEDIR/src/libtag/trueaudioproperties.h) \
        $$quote($$BASEDIR/src/libtag/tstring.h) \
        $$quote($$BASEDIR/src/libtag/tstringlist.h) \
        $$quote($$BASEDIR/src/libtag/uniquefileidentifierframe.h) \
        $$quote($$BASEDIR/src/libtag/unknownframe.h) \
        $$quote($$BASEDIR/src/libtag/unsynchronizedlyricsframe.h) \
        $$quote($$BASEDIR/src/libtag/urllinkframe.h) \
        $$quote($$BASEDIR/src/libtag/vorbisfile.h) \
        $$quote($$BASEDIR/src/libtag/vorbisproperties.h) \
        $$quote($$BASEDIR/src/libtag/wavfile.h) \
        $$quote($$BASEDIR/src/libtag/wavpackfile.h) \
        $$quote($$BASEDIR/src/libtag/wavpackproperties.h) \
        $$quote($$BASEDIR/src/libtag/wavproperties.h) \
        $$quote($$BASEDIR/src/libtag/xingheader.h) \
        $$quote($$BASEDIR/src/libtag/xiphcomment.h) \
        $$quote($$BASEDIR/src/libtag/xmfile.h) \
        $$quote($$BASEDIR/src/libtag/xmproperties.h) \
...
INCLUDEPATH += $$quote($$BASEDIR/src/libtag/src/ogg/vorbis) \
    $$quote($$BASEDIR/src/libtag/src) \
    $$quote($$BASEDIR/src/libtag/src/ogg) \
    $$quote($$BASEDIR/src/Flurry) \
    $$quote($$BASEDIR/src/libmad/msvc++) \
    $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2) \
    $$quote($$BASEDIR/src/libtag/src/mpeg/id3v1) \
    $$quote($$BASEDIR/src) \
    $$quote($$BASEDIR/src/libtag/src/toolkit) \
    $$quote($$BASEDIR/src/libtag/src/mp4) \
    $$quote($$BASEDIR/src/zip) \
    $$quote($$BASEDIR/src/mp3lame/vector) \
    $$quote($$BASEDIR/src/mp3lame) \
    $$quote($$BASEDIR/src/libtag/src/xm) \
    $$quote($$BASEDIR/src/libtag/src/ape) \
    $$quote($$BASEDIR/src/libtag/src/wavpack) \
    $$quote($$BASEDIR/src/libtag/src/flac) \
    $$quote($$BASEDIR/src/libtag/src/it) \
    $$quote($$BASEDIR/src/libtag/src/asf) \
    $$quote($$BASEDIR/src/libtag/src/s3m) \
    $$quote($$BASEDIR/src/libmad) \
    $$quote($$BASEDIR/src/libtag/src/mod) \
    $$quote($$BASEDIR/src/libtag/src/ogg/flac) \
    $$quote($$BASEDIR/src/libtag/src/trueaudio) \
    $$quote($$BASEDIR/src/modplug) \
    $$quote($$BASEDIR/src/libtag/src/riff/wav) \
    $$quote($$BASEDIR/src/libtag/src/ogg/speex) \
    $$quote($$BASEDIR/src/libtag/src/riff) \
    $$quote($$BASEDIR/src/libid3tag) \
    $$quote($$BASEDIR/src/libtag/src/ogg/opus) \
    $$quote($$BASEDIR/src/libtag) \
    $$quote($$BASEDIR/src/libtag/src/riff/aiff) \
    $$quote($$BASEDIR/src/libid3tag/msvc++) \
    $$quote($$BASEDIR/src/libtag/src/mpeg/id3v2/frames) \
    $$quote($$BASEDIR/src/libtag/src/mpeg) \
    $$quote($$BASEDIR/src/libtag/src/mpc)
...
lupdate_inclusion {
    SOURCES += \
        ...
        $$quote($$BASEDIR/../src/libtag/*.c) \
        $$quote($$BASEDIR/../src/libtag/*.c++) \
        $$quote($$BASEDIR/../src/libtag/*.cc) \
        $$quote($$BASEDIR/../src/libtag/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/ape/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/ape/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/ape/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/ape/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/ape/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/asf/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/asf/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/asf/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/asf/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/asf/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/flac/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/flac/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/flac/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/flac/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/flac/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/it/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/it/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/it/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/it/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/it/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/mod/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/mod/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/mod/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/mod/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/mod/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/mp4/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/mp4/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/mp4/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/mp4/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/mp4/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/mpc/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/mpc/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/mpc/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/mpc/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/mpc/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/id3v1/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/id3v1/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/id3v1/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/id3v1/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/id3v1/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/id3v2/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/id3v2/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/id3v2/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/id3v2/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/id3v2/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/id3v2/frames/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/id3v2/frames/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/id3v2/frames/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/id3v2/frames/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/mpeg/id3v2/frames/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/flac/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/flac/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/flac/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/flac/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/flac/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/opus/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/opus/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/opus/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/opus/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/opus/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/speex/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/speex/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/speex/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/speex/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/speex/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/vorbis/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/vorbis/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/vorbis/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/vorbis/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/ogg/vorbis/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/riff/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/riff/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/riff/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/riff/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/riff/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/riff/aiff/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/riff/aiff/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/riff/aiff/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/riff/aiff/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/riff/aiff/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/riff/wav/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/riff/wav/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/riff/wav/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/riff/wav/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/riff/wav/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/s3m/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/s3m/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/s3m/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/s3m/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/s3m/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/toolkit/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/toolkit/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/toolkit/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/toolkit/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/toolkit/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/trueaudio/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/trueaudio/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/trueaudio/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/trueaudio/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/trueaudio/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/wavpack/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/wavpack/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/wavpack/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/wavpack/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/wavpack/*.cxx) \
        $$quote($$BASEDIR/../src/libtag/src/xm/*.c) \
        $$quote($$BASEDIR/../src/libtag/src/xm/*.c++) \
        $$quote($$BASEDIR/../src/libtag/src/xm/*.cc) \
        $$quote($$BASEDIR/../src/libtag/src/xm/*.cpp) \
        $$quote($$BASEDIR/../src/libtag/src/xm/*.cxx) \
